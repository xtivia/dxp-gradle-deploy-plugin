...
class AetherUtil
{
    ...
    static DefaultRepositorySystemSession newRepositorySystemSession(RepositorySystem system, LocalRepository localRepo, ConsoleTransferListener consoleTransferListener )
    {
