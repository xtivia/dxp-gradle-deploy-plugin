 ...
 */
public class GogoTelnetClientImpl implements GogoTelnetClient, AutoCloseable {

    public GogoTelnetClientImpl() throws IOException {
        this("localhost", 11311);
    }

    public GogoTelnetClientImpl(String host, int port) throws IOException {
